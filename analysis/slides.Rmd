...
Data preparation is sometimes >90% of the effort! Common worries:
...
*Many analysis mistakes are due to poor data preparation.* (And we
haven't yet dealt with merging data from multiple files—this usually
...
trip.files   <- Sys.glob("../data/Divvy_Trips*.csv")
station.file <- "../data/Divvy_Stations_2017_Q3Q4.csv"
divvy <- read.divvy.data(station.file,trip.files)
```
