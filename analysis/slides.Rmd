...
*Many analysis mistakes are due to poor data preparation.* (And
merging data from multiple files creates more headaches!)

Moving beyond the data preparation part
=======================================
