...
+ Data analyses are usually *iterative* and *repetitive*. Therefore, you
need to develop skills to *efficiently* create & refine your analyses.

+ The *programmatic approach* to data analysis will allow us to...

    - Reuse our code to quickly create sophisticated
      analyses---*automation is your friend*!
...
> Instructor notes: If you use the RCC cluster I'm assuming you know
> how to set up an interactive computing session with appropriate
> amount of compute time and memory, load R or RStudio, and display
> graphics (e.g., using ThinLinc).
...
> Instructor notes: I'm assuming you have already installed R and/or
> RStudio on your laptop, or you are using the RCC cluster.
...
> Instructor notes: If you are using the RCC cluster, also download
> workshop packet on the cluster.
...
+ **slides.Rmd**: R Markdown source used to generate these
  slides. *Copy & paste code from this file.*
...
> Instructor notes: If you are using an older version of R
> (version 3.3 or less), I strongly recommend upgrading to the latest
> version. Some of the examples may not work in older versions of R.
...
> Instructor notes: If you don't see all 15 CSV files, you have either
> (1) not successfully downloaded and/or unzipped all the files in the
> "data" directory, or (2) you have the wrong working directory.
...
Check that the data were ready correctly, and inspect the table:
...
>
> What happens if we run `summary("stations")` instead of
> `summary(stations)`?
...
> Instructor notes: Did any of these commands give us additional
...
> Instructor notes: How were the rows originally ordered in `stations`?
...
> Instructor notes: What issue did we discover from running these
> commands?
...
> Instructor notes: And we haven't yet dealt with merging data from
> multiple files---this usually creates more headaches!

41. Moving beyond data preparation
==================================
...
44. Import the 2016 & 2017 Divvy data
=====================================
...
45. Import the 2016 & 2017 Divvy data
=====================================
...
> Instructor notes: Variables `stationfile` and `tripfiles` contains
> the names of the files to be imported. They do not actually contain
> any data.
...
> Instructor notes: If someone's computer does not have enough memory to
> load all the trip data, they can load only the Q1 trip files instead:
> 
> ```{r import-divvy-data-1a, eval=FALSE}
> tripfiles <- list.files(pattern = "*Q1.csv")
> ```

47. Inspect the 2016 & 2017 Divvy data
======================================

The output is a "list" object, in which each list element is a data
frame. Let's extract the data frames from the list:
...
48. Our first plot: a map of the Divvy stations
===============================================
...
49. Plot station longitude vs. latitude
=======================================
...
> Instructor notes: The "print" function tells R to draw the plot
> object to the screen.
>
> What geographic features of Chicago are recognizable from this plot?

50. Adjusting the plot
======================
...
51. Use colors to highlight the largest stations
================================================
...
52. Use colors to highlight the largest stations
================================================
...
53. Scale stations by the number of departures
==============================================
...
54. Scale stations by the number of departures
==============================================
...
56. Save your code & session state
==================================
...
57. Compare 2016 & 2017 biking activity (optional)
==================================================
...
# 58. Count trips separately for 2016 & 2017
...
59. Add counts to the stations data frame
=========================================
...
60. Scatterplot of trips by station (2016 vs. 2017)
===================================================
...
61. Scatterplot of trips by station
===================================
...
> Instructor notes: One station stands out because it has had a much
> larger increase in trips than other stations. What is this station?

62. Save your code & session state
==================================
